...
builder.Services.AddSingleton<IRecallDatabaseKeyProvider, WindowsCredentialDatabaseKeyProvider>();
builder.Services.AddRecallInfrastructure(Path.Combine(dataDirectory, "recall.db"));
